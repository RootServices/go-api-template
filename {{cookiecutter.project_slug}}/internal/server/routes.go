...
func addRoutes(mux *http.ServeMux, version version.Version, {{cookiecutter.entity_name_lower}}Repo *repository.EntityRepository[entity.{{cookiecutter.entity_name}}]) {
	...
	mux.Handle("POST /api/{{cookiecutter.entity_name_lower}}", {{cookiecutter.entity_name_lower}}Handler.HandleCreate{{cookiecutter.entity_name}}())
	mux.Handle("GET /api/{{cookiecutter.entity_name_lower}}", {{cookiecutter.entity_name_lower}}Handler.HandleList{{cookiecutter.entity_name}}())
	mux.Handle("GET /api/{{cookiecutter.entity_name_lower}}/{id}", {{cookiecutter.entity_name_lower}}Handler.HandleGet{{cookiecutter.entity_name}}())
	mux.Handle("PUT /api/{{cookiecutter.entity_name_lower}}/{id}", {{cookiecutter.entity_name_lower}}Handler.HandleUpdate{{cookiecutter.entity_name}}())
	mux.Handle("DELETE /api/{{cookiecutter.entity_name_lower}}/{id}", {{cookiecutter.entity_name_lower}}Handler.HandleDelete{{cookiecutter.entity_name}}())
}
